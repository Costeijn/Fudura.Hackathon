...
Q.when(require('./contracts'))
    .then(function (contracts) {
        ...
        var koppelpunt = deploy(contracts.Segment, 2000000, system, "koppelpunt", true);
        var opslag = deploy(contracts.Segment, 2000000, system, "opslag", false);
        ...
        return Q.all([system, opwek1, opwek2, opwekSamen, koppelpunt, opslag, verbruik1, verbruik2, verbruikSamen]);
    })
    .then(function (contracts) {
    ...
    .spread(function (opwek1, opwek2, opwekSamen, koppelpunt, opslag, verbruik1, verbruik2, verbruikSamen) {
        console.log('Connecting segments...');
        var connections = [
            [opwek1, opwekSamen],
            [opwek2, opwekSamen],
            [opwekSamen, koppelpunt],
            [koppelpunt, opslag],
            [koppelpunt, verbruikSamen],
